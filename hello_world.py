...
# print(f"The word you've chosen was {word}")


# Variables
# adjective = input("Pick an adjectve: ")

# madlib = f"Cesar is a very {adjective} guy!"
...
food1 = input("Choose a food: ")

madlib2 = f"Today is the {adj1} day in the {season}! I {verb1} going to the {place1} and {verb2} a huge bowl of {food1}."
